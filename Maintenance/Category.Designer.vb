...
Partial Class Category
    ...
    Private Sub InitializeComponent()
        ...
        Guna2GradientPanel1.Location = New Point(28, 66)
        ...
        ' txtcategory
        ' 
        txtcategory.BorderColor = Color.FromArgb(CByte(207), CByte(58), CByte(109))
        txtcategory.BorderRadius = 12
        txtcategory.CustomizableEdges = CustomizableEdges25
        txtcategory.DefaultText = ""
        txtcategory.DisabledState.BorderColor = Color.FromArgb(CByte(208), CByte(208), CByte(208))
        txtcategory.DisabledState.FillColor = Color.FromArgb(CByte(226), CByte(226), CByte(226))
        ...
        txtcategory.ShadowDecoration.CustomizableEdges = CustomizableEdges26
        txtcategory.Size = New Size(347, 37)
        ...
        PictureBox1.Location = New Point(417, 23)
