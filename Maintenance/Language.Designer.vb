...
Partial Class Language
    ...
    Private Sub InitializeComponent()
        ...
        Label1 = New Label()
        txtlanguage = New Guna.UI2.WinForms.Guna2TextBox()
        ...
        Guna2GradientPanel1.Controls.Add(txtlanguage)
        ...
        ' txtlanguage
        ' 
        txtlanguage.BorderColor = Color.FromArgb(CByte(207), CByte(58), CByte(109))
        txtlanguage.BorderRadius = 12
        txtlanguage.CustomizableEdges = CustomizableEdges1
        txtlanguage.DefaultText = ""
        txtlanguage.DisabledState.BorderColor = Color.FromArgb(CByte(208), CByte(208), CByte(208))
        txtlanguage.DisabledState.FillColor = Color.FromArgb(CByte(226), CByte(226), CByte(226))
        ...
        PictureBox1.Location = New Point(415, 210)
        ...
        txtsearch.PlaceholderText = "Search Language"
