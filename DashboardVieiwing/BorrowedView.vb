    ...
    Public Sub refreshbrw()
        ...
        Try
            ...
            If DataGridView1.Columns.Count > 0 Then
                ...
                End If
                If DataGridView1.Columns.Contains("BorrowedDate") Then
                    DataGridView1.Columns("BorrowedDate").HeaderText = "BORROWED DATE"
                    Try
                        DataGridView1.Columns("BorrowedDate").DefaultCellStyle.Format = "yyyy-MM-dd"
                    Catch
                    End Try
                End If
            End If
