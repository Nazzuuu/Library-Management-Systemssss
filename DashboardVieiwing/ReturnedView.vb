    ...
    Public Sub refreshreturned()
        ...
        Try
            ...
            For Each dr As DataRow In ds.Tables("info").Rows
                ...
                If dr.Field(Of String)("AccessionID") IsNot Nothing Then

                    Dim accessionID As String = dr.Field(Of String)("AccessionID")

                    Dim bookTitle As String = dr.Field(Of String)("BookTitle")


                    dtFinal.Rows.Add(New Object() {accessionID, bookTitle})
