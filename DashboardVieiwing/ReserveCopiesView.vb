...
Public Class ReserveCopiesView
    Private Sub ReserveCopiesView_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        refreshreserve()
    End Sub

    Public Sub refreshreserve()
        ...
        Try
            ...
            Me.Text = $"Reserved Copies ({ds.Tables("info").Rows.Count} Total Books)"
    ...
    Private Sub ReserveCopiesView_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyCode = Keys.Escape Then
            Me.Close()
        End If
    End Sub

    Private Sub RShown(sender As Object, e As EventArgs) Handles MyBase.Shown
