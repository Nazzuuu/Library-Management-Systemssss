...
Public Class MainForm
    ...
    'Private Sub LibraryCardssToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles LibraryCardssToolStripMenuItem.Click
