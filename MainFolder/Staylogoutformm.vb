...
Public Class StayLogoutFormm
    ...
    Public TargetBorrowerID As String = String.Empty
    ...
    Private Sub btnstay_Click(sender As Object, e As EventArgs) Handles btnstay.Click
        ...
        If GlobalVarsModule.CurrentUserRole.Equals(
            "Borrower",
            ...
            If Not IsTimedIn Then
                ...
                Dim timeInPrompt As DialogResult = MessageBox.Show(
    ...
    Private Sub btnlogout_Click(sender As Object, e As EventArgs) Handles btnlogout.Click
        ...
        Try
            ...
            If GlobalVarsModule.CurrentUserRole.Equals(
                ...
                Dim borrowerID As String = If(String.IsNullOrWhiteSpace(TargetBorrowerID), GlobalVarsModule.GetCleanCurrentBorrowerID(), TargetBorrowerID)

                If Not String.IsNullOrEmpty(borrowerID) Then

                    Dim activeRecordID As Integer =
                        GlobalVarsModule.GetLastTimeInRecordID(borrowerID)

                    If activeRecordID = 0 Then

                        Dim stillTimedIn As Boolean =
                            GlobalVarsModule.IsBorrowerStillTimedIn(borrowerID)
                    ...
                    If activeRecordID > 0 Then
                        ...
                        Dim timeoutSuccess As Boolean =
                            GlobalVarsModule.AutomaticTimeOut(activeRecordID)
                    ...
                    Else
                        ...
                        MessageBox.Show(
                            "You have successfully logged out. No active Time-In session was found.",
                            "Logout",
                            MessageBoxButtons.OK,
                            MessageBoxIcon.Information
                        )
            ...
            If Borrowing IsNot Nothing AndAlso
               Not Borrowing.IsDisposed Then
            ...
            Dim activeMain As MainForm =
                GlobalVarsModule.ActiveMainForm
