...
Partial Class Penalty
    ...
    Private Sub InitializeComponent()
        ...
        lblborrowerstatus = New Label()
        Label16 = New Label()
        Label11 = New Label()
        txtfee = New Guna.UI2.WinForms.Guna2TextBox()
        ...
        Guna2GroupBox1.Controls.Add(lbllrn)
        ...
        Label4.TabIndex = 108
        Label4.Text = "Type of Status:"
        ' 
        ' cbstatus
        ' 
        cbstatus.BackColor = Color.Transparent
        cbstatus.BorderColor = Color.FromArgb(CByte(207), CByte(58), CByte(109))
        ...
        cbstatus.Font = New Font("Tahoma", 9.75F, FontStyle.Bold)
        cbstatus.ForeColor = Color.Black
        cbstatus.ItemHeight = 30
        cbstatus.Items.AddRange(New Object() {"PAID", "UNPAID", "REPLACED"})
        cbstatus.Location = New Point(383, 25)
        cbstatus.Name = "cbstatus"
        cbstatus.ShadowDecoration.CustomizableEdges = CustomizableEdges8
        cbstatus.Size = New Size(136, 36)
        cbstatus.TabIndex = 107
        ' 
        ' chkdisregard
        ' 
        ...
        btnpenalized.CustomizableEdges = CustomizableEdges9
        ...
        btnpenalized.ShadowDecoration.CustomizableEdges = CustomizableEdges10
        ...
        lblbookstatus.Font = New Font("Tahoma", 9.75F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        lblbookstatus.ForeColor = Color.FromArgb(CByte(207), CByte(58), CByte(109))
        lblbookstatus.Location = New Point(133, 176)
        lblbookstatus.Name = "lblbookstatus"
        lblbookstatus.Size = New Size(15, 16)
        lblbookstatus.TabIndex = 105
        lblbookstatus.Text = ".."
        ' 
        ' Label21
        ' 
        Label21.AutoSize = True
        Label21.Font = New Font("Tahoma", 9.75F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Label21.ForeColor = Color.FromArgb(CByte(207), CByte(58), CByte(109))
        Label21.Location = New Point(22, 176)
        Label21.Name = "Label21"
        Label21.Size = New Size(90, 16)
        Label21.TabIndex = 104
        Label21.Text = "Book Status:"
        ' 
        ' lbldetails
        ' 
        ...
        lbldetails.Location = New Point(20, 25)
        ...
        ' lblborrowerstatus
        ' 
        lblborrowerstatus.AutoSize = True
        lblborrowerstatus.Font = New Font("Tahoma", 9.75F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        lblborrowerstatus.ForeColor = Color.FromArgb(CByte(207), CByte(58), CByte(109))
        lblborrowerstatus.Location = New Point(146, 141)
        lblborrowerstatus.Name = "lblborrowerstatus"
        lblborrowerstatus.Size = New Size(15, 16)
        lblborrowerstatus.TabIndex = 103
        lblborrowerstatus.Text = ".."
        ' 
        ' Label16
        ' 
        Label16.AutoSize = True
        Label16.Font = New Font("Tahoma", 9.75F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Label16.ForeColor = Color.FromArgb(CByte(207), CByte(58), CByte(109))
        Label16.Location = New Point(23, 213)
        Label16.Name = "Label16"
        Label16.Size = New Size(87, 16)
        Label16.TabIndex = 102
        Label16.Text = "Penalty Fee:"
        ' 
        ' Label11
        ' 
        ...
        Label11.Location = New Point(22, 141)
        Label11.Name = "Label11"
        Label11.Size = New Size(120, 16)
        Label11.TabIndex = 101
        Label11.Text = "Borrower Status:"
        ' 
        ' txtfee
        ' 
        txtfee.BorderColor = Color.FromArgb(CByte(207), CByte(58), CByte(109))
        txtfee.BorderRadius = 12
        txtfee.CustomizableEdges = CustomizableEdges11
        txtfee.DefaultText = ""
        txtfee.DisabledState.BorderColor = Color.FromArgb(CByte(208), CByte(208), CByte(208))
        txtfee.DisabledState.FillColor = Color.FromArgb(CByte(226), CByte(226), CByte(226))
        txtfee.DisabledState.ForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        txtfee.DisabledState.PlaceholderForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        txtfee.FocusedState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        txtfee.Font = New Font("Segoe UI", 9F)
        ...
        txtfee.SelectedText = ""
        txtfee.ShadowDecoration.CustomizableEdges = CustomizableEdges12
        txtfee.Size = New Size(143, 33)
        txtfee.TabIndex = 100
        ' 
        ' lblbooktitle
        ' 
        lblbooktitle.AutoSize = True
        lblbooktitle.Font = New Font("Tahoma", 9.75F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        lblbooktitle.ForeColor = Color.FromArgb(CByte(207), CByte(58), CByte(109))
        lblbooktitle.Location = New Point(344, 107)
        lblbooktitle.Name = "lblbooktitle"
        lblbooktitle.Size = New Size(15, 16)
        lblbooktitle.TabIndex = 99
        lblbooktitle.Text = ".."
        ' 
        ' lblaccessionid
        ' 
        ...
        lblaccessionid.Location = New Point(478, 71)
        ...
        Label18.Location = New Point(386, 72)
        ...
        Label6.Location = New Point(259, 107)
        Label6.Name = "Label6"
        Label6.Size = New Size(70, 16)
        Label6.TabIndex = 50
        Label6.Text = "BookTitle:"
        ' 
        ' lblduedate
        ' 
        ...
        lblduedate.Location = New Point(131, 107)
        ...
        Label8.Location = New Point(259, 72)
        Label8.Name = "Label8"
        ...
        Label17.Location = New Point(20, 107)
        ...
        lblborroweddate.Location = New Point(131, 72)
        ...
        lblbooktotal.Location = New Point(344, 72)
        ...
        LinkLabel1.Font = New Font("Tahoma", 9.75F, FontStyle.Bold)
        LinkLabel1.LinkColor = Color.FromArgb(CByte(207), CByte(58), CByte(109))
        LinkLabel1.Location = New Point(476, 213)
        LinkLabel1.Name = "LinkLabel1"
        LinkLabel1.Size = New Size(69, 16)
        LinkLabel1.TabIndex = 109
        LinkLabel1.TabStop = True
        LinkLabel1.Text = "View Paid"
        ' 
        ' Penalty
        ' 
    ...
    Friend WithEvents btnpenalized As Guna.UI2.WinForms.Guna2Button
