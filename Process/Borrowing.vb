...
Public Class Borrowing
    ...
    Private Sub btnclear_Click(sender As Object, e As EventArgs) Handles btnclear.Click
        Try
            If String.Equals(GlobalVarsModule.CurrentUserRole, "Borrower", StringComparison.OrdinalIgnoreCase) Then
                ClearBookFieldsForBorrower()
            Else
                ClearBookFields()
            End If
        Catch
    ...
    Private Sub ClearBookFieldsForBorrower()
