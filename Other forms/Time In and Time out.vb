...
Public Class oras
    ...
    Private Sub btnregisterview_Click(sender As Object, e As EventArgs) Handles btnregisterview.Click
        ...
        RegisteredBrwr.IsTimeInMode = (GlobalVarsModule.CurrentUserRole = "Borrower")
        ...
        Dim stayForm = Application.OpenForms.OfType(Of StayLogoutFormm)().FirstOrDefault()
        If stayForm IsNot Nothing Then
            stayForm.TargetBorrowerID = GlobalVarsModule.CurrentBorrowerID
        End If
